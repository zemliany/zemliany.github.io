...
title: "Manage SCM and String parameters in Jenkins job using Groovy"
date: "2025-02-14"
...
During our work in some part of CI job migrations from old scm to GitLab we faced with the issue when we need to change configuration for a huge bunch of CI jobs in field of StringParameters and SCM configuration with credentials from one to another I made script that doing it in easy way per folder1
<!--more-->
